...
public class SearchTvProgramsSpec {

    //검색 파라메터 키값 설정
    @AllArgsConstructor
    @Getter
    public enum SearchKey{
          NAME_LIKE("programName")
        , VIEW_FLAG("viewFlag")
    ...
    public static Specification<TvPrograms> createSpecification(Map<String, Object> searchRequest, List<String> defaultSearchParam){
        ...
        return (Specification<TvPrograms>) ((root, query, builder) -> {
            ...
            for (SearchKey key : searchKeyword.keySet()) {
                ...
                switch (key) {
                    case NAME_LIKE:
                        ...
                        break;
                    case VIEW_FLAG:
                        predicate.add(builder.equal(root.get("viewFlag"),  keyValue));
                        break;
