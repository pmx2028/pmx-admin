                                            ...
                                            <div class="dataTables_paginate">
                                                <ul class="pagination pagination-flat pagination-rounded align-self-right">
                                                    <#if 1 < paging.nowPageNo?c?number>
                                                        <li class="page-item"><a href="${pageUrl}" class="page-link"><i class="fa fa-angle-double-left"></i></a></li>
                                                    <#else>
                                                    ...
                                                    <#if 0 < paging.prevPageNumber?c?number>
                                                        <li class="page-item"><a href="${pageUrl}page=${paging.prevPageNumber?c}" class="page-link"><i class="fa fa-angle-left"></i></a></li>
                                                    <#else>
                                                    ...
                                                    <#list paging.minPageNumber..paging.maxPageNumber as n>
                                                        <#if paging.nowPageNo = n>
                                                            <li class="page-item active"><a href="#" class="page-link">${n}</a></li>
                                                        <#else>
                                                            <li class="page-item"><a href="${pageUrl}page=${n?c}" class="page-link">${n}</a></li>
                                                        </#if>
                                                    </#list>
                                                    
                                                    <#if 0 < paging.nextPageNumber?c?number>
                                                        <li class="page-item"><a href="${pageUrl}page=${paging.nextPageNumber?c}" class="page-link"><i class="fa fa-angle-right"></i></a></li>
                                                    <#else>
                                                    ...
                                                    <#if paging.nowPageNo?c?number < paging.lastPageNumber?c?number>
                                                        <li class="page-item"><a href="${pageUrl}page=${paging.lastPageNumber?c}" class="page-link"><i class="fa fa-angle-double-right"></i></a></li>
                                                    <#else>
                                                        <li class="page-item disabled"><a href="#" class="page-link"><i class="fa fa-angle-double-right"></i></a></li>
                                                    </#if>
                                                </ul>
                                                <#--  <a class="paginate_button previous disabled"><i class="fa fa-angle-left"></i></a>
                                                <a class="paginate_button previous disabled"><i class="fa fa-angle-double-left"></i></a>
                                                <span>
                                                ...
                                                <a class="paginate_button next"><i class="fa fa-angle-right"></i></a>
                                                <a class="paginate_button next"><i class="fa fa-angle-double-right"></i></a>  -->
                                            </div>